...
namespace FeatureExtraction
{
    ...
    {
        // file paths
        private const string inputFilePath = @"D:/Abertay Uni Stuff/Computing/3rd year/304/AI part 2/MLApp2/MLApp2/MLApp2/Cohn-Kanade Images/";
		...
		static void Main(string[] args)
        {
			...
			for (var n = 0; n < 7; n++)
			{
				...
				for (int f = 0; f < files.Length; f++)
				{
					...
					using (var sp = ShapePredictor.Deserialize(@"D:/Abertay Uni Stuff/Computing/3rd year/304/AI part 2/MLApp2/MLApp2/MLApp2/shape_predictor_68_face_landmarks.dat"))
					{
						// load input image
